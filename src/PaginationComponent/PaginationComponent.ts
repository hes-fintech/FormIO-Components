...
export class paginationComponent extends ContainerComponent {
    ...
    getPagesNum() {
        ...
        const totalElementsValue =
            formattedTotalElementsValue ||
            _.get((this as any).root.data, (this as any).component.dataSourcePath)?.length;
    ...
    getInitialPaginatedData() {
        return (this as any).component.dataSourcePath
            ? this.paginateArray(
                  _.get((this as any).root.data, (this as any).component.dataSourcePath),
                  1,
    ...
    setPageSize(page: string) {
        const currentPageSizeComponent = (Utils as any).getComponent(
            (this as any).components,
            'itemsPerPage',
        );
    ...
    getComponentTemplate(children) {
        ...
        <div class="drag-container">
          ${(this as any).component.label}
            ...
            : super.render(
                  children ||
                      (this as any).renderTemplate(this.templateName, {
    ...
    checkRefresh(refreshData, changed, flags) {
        ...
        if (refreshData === 'data') {
            ...
            changePath &&
            (Utils as any).getComponentPath(changed.instance) === refreshData &&
            changed &&
            changed.instance &&
