export const paginationComponentApiEditData = [
    {
        ...
        tooltip:
            'Use this path to paginate data in the submission if you have a full list that needs to be paginated. There is no need to use it if you have an endpoint with paginated data.',
        key: 'dataSourcePath',
        weight: 1,
    },
    {
        ...
        tooltip:
            'Path to total elements value in case you are use request for paginated data. Use it if you have endpoint with paginated data.',
